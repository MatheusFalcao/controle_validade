...
class ValidadesControllerTest < ActionController::TestCase
  ...
  test "should create validade" do
    assert_difference('Validade.count') do
      post :create, validade: { produto_id: @validade.produto_id, user_id: @validade.user_id, vencimento: @validade.vencimento }
    end
  ...
  test "should update validade" do
    patch :update, id: @validade, validade: { produto_id: @validade.produto_id, user_id: @validade.user_id, vencimento: @validade.vencimento }
    assert_redirected_to validade_path(assigns(:validade))
  end
